-- ANVENDT LIVE i xpgoztaraqdvliitkkfv som versjon
-- 20260912210449_fix_snapshot_retry_lock_under_rls.
-- SKAL IKKE KJØRES PÅ NYTT. Ordrett kopi hentet fra
-- supabase_migrations.schema_migrations.
--
-- Bakgrunn: 20260912205629 innførte SELECT ... FOR UPDATE i
-- save_production_plan_snapshot. production_plan_snapshots har bevisst INGEN
-- UPDATE-policy for authenticated, så FOR UPDATE skjulte den eksisterende
-- raden ved identisk nytt forsøk og lagringen feilet med 23505 (duplikat
-- primærnøkkel) i stedet for å være idempotent. Rettingen serialiserer
-- forsøket med en transaksjons-advisory lock per forsøks-id og bruker vanlig
-- SELECT. Ingen policy er utvidet.
