...
BEGIN
  ...
  -- Velg "hoved"-produktet. Prioritet:
  --   1) Valgt alternativ i et steg med suggested_role = 'base'
  --   2) Valgt alternativ der produktet har cake_role = 'base'
  --   3) Fallback til kategoriens basis-produkt
  ...
  -- Hvis kategorien har et påkrevd base-steg men kunden ikke valgte et produkt
  -- der: feil hardt, ellers ville vi feilaktig falt tilbake til basis-produktet.
  IF v_main_product.id IS NULL THEN
    SELECT EXISTS (
