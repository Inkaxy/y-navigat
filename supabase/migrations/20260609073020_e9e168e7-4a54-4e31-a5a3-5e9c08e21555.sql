CREATE OR REPLACE FUNCTION public.pos_record_sale(p_session_id uuid, p_lines jsonb, p_payment_summary jsonb, p_transaction_type text DEFAULT 'sale'::text, p_dining_mode text DEFAULT 'takeaway'::text, p_customer_id uuid DEFAULT NULL::uuid, p_reference_transaction_id uuid DEFAULT NULL::uuid, p_is_training boolean DEFAULT false)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  -- D1-fiks: pos_next_receipt_number returnerer TABLE, ikke jsonb
