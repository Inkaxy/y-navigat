...
const schema = z.object({
  ...
  item_type: z
    .enum(["ravare", "emballasje", "forbruksvare", "videresalg"])
    .default("ravare"),
...
export function NewRawMaterialDialog({
  open,
  onOpenChange,
  onCreated,
  initialName,
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="f.eks. MEL-001" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="f.eks. Hvetemel Sigdal" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
