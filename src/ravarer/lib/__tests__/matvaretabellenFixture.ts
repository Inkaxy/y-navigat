...
export const MATVARETABELLEN_FIXTURE: FoodCandidate[] = [
  ...
  { food_id: "mel-3", food_name: "Hvetemel, sammalt, fint", food_group_name: "Mel" },
  { food_id: "mel-4", food_name: "Hvetemel, sammalt, grovt", food_group_name: "Mel" },
  ...
  { food_id: "smo-5", food_name: "Matlagingsfett", food_group_name: "Margarin og smør", search_keywords: ["smør"] },
