...
const AREAS: Area[] = [
  ...
  { to: "/admin/outlets",      title: "Outlets",      desc: "Butikker, bakerier og produksjonssteder.",    icon: Store, active: false },
  { to: "/admin/stillinger",   title: "Stillinger",   desc: "Stillingsmaler og kategorier.",               icon: Briefcase, active: false },
  { to: "/admin/apper",        title: "Apper",        desc: "Registrerte NBOS-apper og status.",           icon: AppWindow, active: false },
